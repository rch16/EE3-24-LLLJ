...
if addr_detected():
    ...
    while True:
        ...
        # if obj_temp != prev_obj_temp:
            # print('obj_temp = {0}C'.format(obj_temp))
            # prev_obj_temp = obj_temp
        # if die_temp != prev_die_temp:
            # print('die_temp = {0}C'.format(die_temp))
            # prev_die_temp = die_temp
